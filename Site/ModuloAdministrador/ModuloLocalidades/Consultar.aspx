<%@ Page Title="" Language="C#" MasterPageFile="~/ModuloAdministrador/MasterPageAdministrador.master" AutoEventWireup="true" CodeFile="Consultar.aspx.cs" Inherits="ModuloAdministrador_ModuloLocalidades_Consultar" %>

<%@ Register src="~/ModuloAdministrador/ModuloLocalidades/LocalidadesSelecionar.ascx" tagname="LocalidadesSelecionar" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" Runat="Server">
Consultar Postagens Localidades
</asp:Content>
...
<div id="AvisoDeErro1" style="text-align: center;">
        ...
        <asp:CustomValidator ID="cvaAvisoDeInformacao" runat="server" ValidationGroup="AvisoDeInformacao"
            ...
            <uc1:LocalidadesSelecionar ID="LocalidadesSelecionar1" runat="server" />
             <table width="100%">
            <tr align="center">
                <td>
                    <table>
                        <tr>
                            <td>
                                <asp:Button ID="btnIncluir" runat="server" Text="Incluir" CssClass="botao" Font-Bold="True" ForeColor="#0033CC" PostBackUrl="~/ModuloAdministrador/ModuloLocalidades/Incluir.aspx" />
