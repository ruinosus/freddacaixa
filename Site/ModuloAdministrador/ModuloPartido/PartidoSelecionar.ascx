<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PartidoSelecionar.ascx.cs" Inherits="ModuloAdministrador_ModuloPartido_PartidoSelecionar" %>
    ...
    <tr align="center">
        ...
        <td align="center">
            ...
            <asp:Button ID="btnPesquisar" runat="server" CssClass="botao" Font-Bold="True" ForeColor="#0033CC" OnClick="btnPesquisar_OnClick" Style="position: relative"
                Text="Pesquisar" TabPartido="2" />
        </td>
    </tr>
    <tr>
        <td align="center" >
            <asp:GridView ID="GrdPartido" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                Width="100%" CellPadding="4" GridLines="None" OnPagePartidoChanging="grdPartido_PagePartidoChanging"
                OnRowCreated="grdPartido_RowCreated" OnPreRender="grdPartido_PreRender" ForeColor="#333333" PageSize="9">
                <RowStyle BackColor="#EFF3FB" />
                <Columns>
                    <asp:TemplateField HeaderText="&amp;nbsp;">
                        <ItemTemplate>
                            <asp:RadioButton ID="idPartido" runat="server" value='<%# Eval("ID") %>' onclick='<%# GetOnSelectEvent(Eval("ID"))%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="2%" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Título">
                        <ItemTemplate>
                            <asp:Label ID="lblTitulo" AssociatedControlID="idPartido" runat="server" Text='<%# Eval("Titulo") %>' />
                        </ItemTemplate>
