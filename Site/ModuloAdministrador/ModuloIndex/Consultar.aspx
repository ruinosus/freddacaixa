<%@ Page Title="" Language="C#" MasterPageFile="~/ModuloAdministrador/MasterPageAdministrador.master" AutoEventWireup="true" CodeFile="Consultar.aspx.cs" Inherits="ModuloAdministrador_ModuloIndex_Consultar" %>

<%@ Register src="~/ModuloAdministrador/ModuloIndex/IndexSelecionar.ascx" tagname="IndexSelecionar" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" Runat="Server">
Consultar Postagens Index
</asp:Content>
...
<div id="AvisoDeErro1" style="text-align: center;">
        ...
        <asp:CustomValidator ID="cvaAvisoDeInformacao" runat="server" ValidationGroup="AvisoDeInformacao"
            ...
            <uc1:IndexSelecionar ID="IndexSelecionar1" runat="server" />
             <table width="100%">
            <tr align="center">
                <td>
                    <table>
                        <tr>
                            <td>
                                <asp:Button ID="btnIncluir" runat="server" Text="Incluir" CssClass="botao" Font-Bold="True" ForeColor="#0033CC" PostBackUrl="~/ModuloAdministrador/ModuloIndex/Incluir.aspx" />
