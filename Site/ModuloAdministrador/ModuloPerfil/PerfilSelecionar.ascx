<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PerfilSelecionar.ascx.cs" Inherits="ModuloAdministrador_ModuloPerfil_PerfilSelecionar" %>
    ...
    <tr align="center">
        ...
        <td align="center">
            ...
            <asp:Button ID="btnPesquisar" runat="server" CssClass="botao" Font-Bold="True" ForeColor="#0033CC" OnClick="btnPesquisar_OnClick" Style="position: relative"
                Text="Pesquisar" TabPerfil="2" />
        </td>
    </tr>
    <tr>
        <td align="center" >
            <asp:GridView ID="GrdPerfil" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                Width="100%" CellPadding="4" GridLines="None" OnPagePerfilChanging="grdPerfil_PagePerfilChanging"
                OnRowCreated="grdPerfil_RowCreated" OnPreRender="grdPerfil_PreRender" ForeColor="#333333" PageSize="9">
                <RowStyle BackColor="#EFF3FB" />
                <Columns>
                    <asp:TemplateField HeaderText="&amp;nbsp;">
                        <ItemTemplate>
                            <asp:RadioButton ID="idPerfil" runat="server" value='<%# Eval("ID") %>' onclick='<%# GetOnSelectEvent(Eval("ID"))%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="2%" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Título">
                        <ItemTemplate>
                            <asp:Label ID="lblTitulo" AssociatedControlID="idPerfil" runat="server" Text='<%# Eval("Titulo") %>' />
                        </ItemTemplate>
