<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PropostaSelecionar.ascx.cs" Inherits="ModuloAdministrador_ModuloProposta_PropostaSelecionar" %>
    ...
    <tr align="center">
        ...
        <td align="center">
            ...
            <asp:Button ID="btnPesquisar" runat="server" CssClass="botao" Font-Bold="True" ForeColor="#0033CC" OnClick="btnPesquisar_OnClick" Style="position: relative"
                Text="Pesquisar" TabProposta="2" />
        </td>
    </tr>
    <tr>
        <td align="center" >
            <asp:GridView ID="GrdProposta" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                Width="100%" CellPadding="4" GridLines="None" OnPagePropostaChanging="grdProposta_PagePropostaChanging"
                OnRowCreated="grdProposta_RowCreated" OnPreRender="grdProposta_PreRender" ForeColor="#333333" PageSize="9">
                <RowStyle BackColor="#EFF3FB" />
                <Columns>
                    <asp:TemplateField HeaderText="&amp;nbsp;">
                        <ItemTemplate>
                            <asp:RadioButton ID="idProposta" runat="server" value='<%# Eval("ID") %>' onclick='<%# GetOnSelectEvent(Eval("ID"))%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="2%" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Título">
                        <ItemTemplate>
                            <asp:Label ID="lblTitulo" AssociatedControlID="idProposta" runat="server" Text='<%# Eval("Titulo") %>' />
                        </ItemTemplate>
