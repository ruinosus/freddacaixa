<%@ Page Title="" Language="C#" MasterPageFile="~/ModuloAdministrador/MasterPageAdministrador.master" AutoEventWireup="true" CodeFile="ConsultarGaleria.aspx.cs" Inherits="ModuloAdministrador_ModuloGaleria_ConsultarGaleria" %>

<%@ Register src="~/ModuloAdministrador/ModuloGaleria/GaleriaSelecionar.ascx" tagname="GaleriaSelecionar" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" Runat="Server">
Consultar Postagens Galeria
</asp:Content>
...
<div id="AvisoDeErro1" style="text-align: center;">
        ...
        <asp:CustomValidator ID="cvaAvisoDeInformacao" runat="server" ValidationGroup="AvisoDeInformacao"
            ...
            <uc1:GaleriaSelecionar ID="GaleriaSelecionar1" runat="server" />
             <table width="100%">
            <tr align="center">
                <td>
                    <table>
