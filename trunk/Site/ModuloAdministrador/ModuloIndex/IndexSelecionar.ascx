<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IndexSelecionar.ascx.cs" Inherits="ModuloAdministrador_ModuloIndex_IndexSelecionar" %>
 ...
 <div id="AvisoDeErro1" style="text-align: center;">
    ...
    <tr>
        <td align="center" >
            <asp:GridView ID="GrdIndex" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                Width="100%" CellPadding="4" GridLines="None" OnPageIndexChanging="grdIndex_PageIndexChanging"
                OnRowCreated="grdIndex_RowCreated" OnPreRender="grdIndex_PreRender" ForeColor="#333333" PageSize="9">
                <RowStyle BackColor="#EFF3FB" />
                <Columns>
                    <asp:TemplateField HeaderText="&amp;nbsp;">
                        <ItemTemplate>
                            <asp:RadioButton ID="idIndex" runat="server" value='<%# Eval("ID") %>' onclick='<%# GetOnSelectEvent(Eval("ID"))%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="2%" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Título">
                        <ItemTemplate>
                            <asp:Label ID="lblTitulo" AssociatedControlID="idIndex" runat="server" Text='<%# Eval("Titulo") %>' />
                        </ItemTemplate>
