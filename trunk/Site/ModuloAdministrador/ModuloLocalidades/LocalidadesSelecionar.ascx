<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LocalidadesSelecionar.ascx.cs" Inherits="ModuloAdministrador_ModuloLocalidades_LocalidadesSelecionar" %>
    ...
    <tr align="center">
        ...
        <td align="center">
            <asp:Label ID="lblTitulo" runat="server" Font-Bold="True" 
                                ForeColor="#0033CC" Text="Descricao:" Font-Names="Arial"></asp:Label>
            ...
            <asp:Button ID="btnPesquisar" runat="server" CssClass="botao" Font-Bold="True" ForeColor="#0033CC" OnClick="btnPesquisar_OnClick" Style="position: relative"
                Text="Pesquisar" TabLocalidades="2" />
        </td>
    </tr>
    <tr>
        <td align="center" >
            <asp:GridView ID="GrdLocalidades" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                Width="100%" CellPadding="4" GridLines="None" OnPageIndexChanging="grdLocalidades_PageIndexChanging"
                OnRowCreated="grdLocalidades_RowCreated" OnPreRender="grdLocalidades_PreRender" ForeColor="#333333" PageSize="9">
                <RowStyle BackColor="#EFF3FB" />
                <Columns>
                    <asp:TemplateField HeaderText="&amp;nbsp;">
                        <ItemTemplate>
                            <asp:RadioButton ID="idLocalidades" runat="server" value='<%# Eval("ID") %>' onclick='<%# GetOnSelectEvent(Eval("ID"))%>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="2%" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Descricao">
                        <ItemTemplate>
                            <asp:Label ID="lblTitulo" AssociatedControlID="idLocalidades" runat="server" Text='<%# Eval("Descricao") %>' />
                        </ItemTemplate>
